    ...
    while run:
        ...
        for i, spaceship in enumerate(spaceships):
            output = nets[i].activate((
                ...
                bullets[i].shoot,
                enemy_waves[i].enemy_list[0].x, enemy_waves[i].enemy_list[0].y, enemy_waves[i].enemy_list[0].velx,  enemy_waves[i].enemy_list[4].vely,
                enemy_waves[i].enemy_list[1].x, enemy_waves[i].enemy_list[1].y, enemy_waves[i].enemy_list[1].velx,  enemy_waves[i].enemy_list[4].vely,
                enemy_waves[i].enemy_list[2].x, enemy_waves[i].enemy_list[2].y, enemy_waves[i].enemy_list[2].velx,  enemy_waves[i].enemy_list[4].vely,
                enemy_waves[i].enemy_list[3].x, enemy_waves[i].enemy_list[3].y, enemy_waves[i].enemy_list[3].velx,  enemy_waves[i].enemy_list[4].vely,
                enemy_waves[i].enemy_list[4].x, enemy_waves[i].enemy_list[4].y, enemy_waves[i].enemy_list[4].velx,  enemy_waves[i].enemy_list[4].vely,
            ))
            #print(output)
